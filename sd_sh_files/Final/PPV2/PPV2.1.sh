...
python ~/SafetyAwareModelBasedRL/dreamer.py --configs defaults --logdir /scratch/users/k21176641/final/PP2/ar_3/1 --action_repeat 3 --imag_horizon 20 --lag_clip 10 --steps 2e6 --lag_grad_clip 1000 --actor_entropy 6e-4 --task Safexp-PointPush2-v0 --dyn_hidden 2048 --dyn_deter 2048 --units 768 --reward_layers 3 --cost_layers 3 --discount_layers 3 --value_layers 4 --actor_layers 5 --cnn_depth 96
